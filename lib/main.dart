import 'package:curricula_apple/screens/on_boarding.dart';
...
void main() async {
  ...
  Widget widget;
  bool onBoarding = CacheHelper.getData(key: 'watched') ?? false;
      ...
      builder: (context, child) {
        ...
        return MaterialApp(
          ...
          routes: {
            ...
            '/category-curricula': (context) => const CategoryCurriculaScreen(),
